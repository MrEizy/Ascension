package net.zic.ascension.datapack.skill.passive;
    ...
    public MapCodec<? extends Skill> codec() {
        return RecordCodecBuilder.<SimplePassiveSkill>mapCodec(instance ->
                instance.group(
                        ...
                        ValueContainer.BASE_MODIFIER_CODEC.listOf().optionalFieldOf("base_stats", List.of()).forGetter(SimplePassiveSkill::getBaseStats),
                        ValueContainerModifier.MAP_CODEC.optionalFieldOf("stat_modifiers", Map.of()).forGetter(SimplePassiveSkill::getStatModifiers),
                        ValueContainer.BASE_MODIFIER_CODEC.listOf().optionalFieldOf("base_affinity",List.of()).forGetter(SimplePassiveSkill::getBaseAffinities),
