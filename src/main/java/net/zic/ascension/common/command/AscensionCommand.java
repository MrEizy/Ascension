...
import net.zic.ascension.common.command.commands.MobCultivationCommand;
import net.zic.ascension.common.command.commands.ResetAscensionCommand;
import net.zic.ascension.common.command.commands.SetCultivationCommand;
