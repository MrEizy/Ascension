package net.zic.ascension.common.items;
...
import net.zic.ascension.common.items.artifacts.talismans.*;
import net.zic.ascension.common.items.techniques.TechniqueBinderItem;
import net.zic.ascension.common.items.techniques.TechniquePageItem;
import net.zic.ascension.common.items.tools.herbs.MortarAndPestle;
import net.zic.ascension.common.items.tools.herbs.SpiritualMeal;
import net.zic.ascension.common.items.tools.hidden_weapons.NeedleItem;
import net.zic.ascension.entity.ModEntities;
import net.zic.ascension.common.items.artifacts.*;
import net.zic.ascension.common.items.data_components.ModDataComponents;

import net.zic.ascension.common.items.herbs.*;
import net.zic.ascension.common.items.physiques.PhysiqueTransferItem;
import net.zic.ascension.common.items.pills.*;
import net.zic.ascension.common.items.stones.SpatialStoneItem;
import net.zic.ascension.common.items.techniques.ScholarlySoulChapterItem;
import net.zic.ascension.common.items.techniques.TechniqueTransferItem;
import net.zic.ascension.common.items.tools.BladeItem;
import net.zic.ascension.common.items.tools.FanItem;
import net.zic.ascension.common.items.tools.SpearItem;
import net.zic.ascension.common.items.tools.SpiritualStoneTools;
import net.zic.ascension.refactor_packages.alchemy.ModPillEffects;
import net.zic.ascension.refactor_packages.techniques.custom.technique_data.ScholarlySoulTechniqueData;
import net.zic.ascension.util.ItemUtil;
