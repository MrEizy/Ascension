...
public record ParticleFieldDefinition(
    ...
    public static final List<ParticleFieldParticleEntry> DEFAULT_PARTICLES = List.of(
            new ParticleFieldParticleEntry(ParticleFieldParticleKind.SPARK, 4),
            new ParticleFieldParticleEntry(ParticleFieldParticleKind.WISP, 3),
            new ParticleFieldParticleEntry(ParticleFieldParticleKind.MOTE, 3),
            new ParticleFieldParticleEntry(ParticleFieldParticleKind.BLOB, 1)
    );
    public static final List<ParticleFieldColour> DEFAULT_COLOURS = List.of(
            new ParticleFieldColour(0xD8F4FF)
    );
    public static final double DEFAULT_DENSITY = 40.0D;
    public static final ParticleFieldDoubleRange DEFAULT_RADIUS = new ParticleFieldDoubleRange(1.2D, 2.8D);
    public static final ParticleFieldDoubleRange DEFAULT_HEIGHT = new ParticleFieldDoubleRange(-0.1D, 2.4D);
    public static final ParticleFieldDoubleRange DEFAULT_SPEED = new ParticleFieldDoubleRange(0.035D, 0.075D);
    public static final ParticleFieldDoubleRange DEFAULT_SIZE = new ParticleFieldDoubleRange(0.07D, 0.18D);
    public static final ParticleFieldIntRange DEFAULT_LIFETIME = new ParticleFieldIntRange(22, 42);
