...
public abstract class DataSourceAddedEvent extends DataSourceEvent{
    protected DataSourceAddedEvent(Identifier dataSource, DataSourceInstance data, AscensionOriginSource source) {
        super(dataSource, data, source);
    }
    public static class Pre extends DataSourceAddedEvent implements ICancellableEvent{

        public Pre(Identifier dataSource, DataSourceInstance data, AscensionOriginSource source) {
            super(dataSource, data, source);
        }
    }
    public static class Post extends DataSourceAddedEvent{

        public Post(Identifier dataSource, DataSourceInstance data, AscensionOriginSource source) {
            super(dataSource, data, source);
        }
    }
}
