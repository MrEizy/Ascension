package net.zic.ascension.menus;
...
import net.zic.ascension.menus.custom.spirit_ring.SpatialRingInventoryMenu;
import net.zic.ascension.menus.custom.spirit_ring.SpatialRingModifierMenu;
