...
public final class KillProgressionTechniqueType extends TechniqueType {
    ...
    public MapCodec<? extends Technique> codec() {
        return RecordCodecBuilder.<KillProgressionTechnique>mapCodec(instance ->
                instance.group(
                        ...
                        ProgressActionHolder.PROGRESS_HOLDER_CODEC.fieldOf("realm_change_handler").forGetter(KillProgressionTechnique::getHolder),
