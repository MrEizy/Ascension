...
public final class PassiveSkillType extends SkillType {
    ...
    public MapCodec<? extends Skill> codec() {
        return RecordCodecBuilder.<PassiveSkill>mapCodec(instance -> instance.group(
                ...
                Codec.INT.optionalFieldOf("default_accessible_level", 1).forGetter(PassiveSkill::getConfiguredDefaultAccessibleLevel),
                Codec.DOUBLE.listOf().optionalFieldOf("experience_requirements", List.of()).forGetter(PassiveSkill::getExperienceRequirements),
