package net.zic.ascension.refactor_packages.skill_casting;
...
import net.zic.ascension.refactor_packages.skill_casting.casting.CastEndReason;
import net.zic.ascension.refactor_packages.skill_casting.casting.CastResult;
import net.zic.ascension.refactor_packages.skill_casting.casting.CastingInstance;
import net.zic.ascension.refactor_packages.skill_casting.persistent_casting.PersistentCastingInstance;
...
import net.zic.ascension.refactor_packages.skills.castable.IPersistentSkillInstance;
