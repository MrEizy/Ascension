package net.zic.ascension.refactor_packages.skills.custom.cultivation.essence;
...
import net.zic.ascension.refactor_packages.breakthroughs.IBreakthroughInstance;
import net.zic.ascension.refactor_packages.breakthroughs.NineHeavenlyTribulations;
import net.zic.ascension.refactor_packages.entity_data.IEntityData;
import net.zic.ascension.refactor_packages.events.CultivateEvent;
import net.zic.ascension.refactor_packages.gui.elements.info_elements.DescriptionDisplayContainer;
import net.zic.ascension.refactor_packages.gui.elements.skills.cultivation.CultivationProgressBar;
...
import net.zic.ascension.refactor_packages.skill_casting.casting.CastEndData;
import net.zic.ascension.refactor_packages.skill_casting.casting.CastResult;
import net.zic.ascension.refactor_packages.skills.IPersistentSkillData;
import net.zic.ascension.refactor_packages.skills.castable.CastType;
import net.zic.ascension.refactor_packages.skills.castable.ICastData;
import net.zic.ascension.refactor_packages.skills.castable.ICastableSkill;
import net.zic.ascension.refactor_packages.skills.castable.IPreCastData;
...
import net.zic.ascension.refactor_packages.techniques.custom.essence.BloodfeastSoulRefiningTechnique;
import net.zic.ascension.refactor_packages.techniques.custom.technique_data.BloodfeastTechniqueData;
