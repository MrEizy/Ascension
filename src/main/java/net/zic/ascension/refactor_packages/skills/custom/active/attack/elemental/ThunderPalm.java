package net.zic.ascension.refactor_packages.skills.custom.active.attack.elemental;
...
import net.zic.ascension.refactor_packages.handlers.AscensionDamageHandler;
...
import net.zic.ascension.refactor_packages.skills.custom.SkillTargetingHelper;
import net.zic.ascension.refactor_packages.skills.custom.active.SimpleInstantCastSkill;
...
public class ThunderPalm extends SimpleInstantCastSkill {
    ...
    @Override
    public CastResult canCast(Entity caster, net.zic.ascension.refactor_packages.skills.castable.IPreCastData preCastData) {
    ...
    @Override
    public void initialCast(Entity caster, net.zic.ascension.refactor_packages.skills.castable.IPreCastData preCastData) {
