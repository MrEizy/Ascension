package net.zic.ascension.refactor_packages.events.skills;
...
import net.zic.ascension.refactor_packages.skills.custom.passive.weapon.GenericWeaponMasterySkill;
