package net.zic.ascension.configuration.dimension.v2;
...
public record DimensionConfiguration(long capacity, long regenRate, Object2DoubleMap<Identifier> affinities){
    ...
    public static DimensionConfiguration getConfiguration(Level level){
        level.registryAccess().lookupOrThrow(Registries.DIMENSION).getData(ConfigurationDataMaps.DIMENSION_CONFIGURATION,level.dimension());
    }
}
